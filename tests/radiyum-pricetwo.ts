...
describe("radiyum-price", () => {
  ...
  it("fetch!", async () => {
    ...
    const tokenB = "EzpUPw9yqJg7c2BhkLL5EtKdwQmAQ7veWK8ZoMw7XH2k";
  ...
  try{
    ...
    const txHash = await program.methods
      .fetch()
      .accounts({
        ammInfo: new PublicKey(
          "gsDvf1L2Z6VvDjSAaXkx46SNowiXmWihoxyZVaa2LoX"
        ),
        targetOrders: new PublicKey(
          "8Xyfs2RoNHm9s68dWZDF7W2B1ivziTqEuGaiFwLBbiRS"
        ),
        ammCoinVault: new PublicKey(
          "9UqAuT4Ck7BJwK43yzoTMjL6Cdyv3QwtmQH1bKD1Xoin"
        ),
        ammPcVault: new PublicKey(
          "EsDbLDuAiJD4uwmgobaBwEwJcodznifkynARbhh9YzhN"
        ),
